...
Self-contained — no yahboom_oled dependency.
Uses Adafruit_SSD1306 directly (the same chip/library the Yahboom code uses).

Install on the robot:
    pip install Adafruit-SSD1306 Pillow psutil

Display: 128×32 SSD1306, 4 rows of 8 px text.
Refreshes every 2 s in a background thread.
"""
